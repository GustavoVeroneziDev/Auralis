...
$allowed = [
    ...
    'clothingColor'   => ['262e33','3c4f5c','65c9ff','929598','a7ffc4','b1e2ff','e6e6e6','ff5c5c','ff488e','ffafb9','ffd670','ffffed'], // salvo como clothingColor, enviado como clothesColor[] para DiceBear
    ...
    'backgroundColor' => ['transparent','b6e3f4','c0aede','d1d4f9','ffd5dc','ffeba4'],
];
...
foreach ($allowed as $key => $values) {
    $val = $_POST[$key] ?? '';
    $config[$key] = in_array($val, $values, true) ? $val : ($defaults[$key] ?? $values[0] ?? '');
}

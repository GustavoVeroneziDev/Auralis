...
<section class="position-relative overflow-hidden" style="padding: clamp(4rem,10vw,7rem) 0;">
    ...
    <div class="container text-center position-relative">
        ...
        <p class="text-secondary mb-5 mx-auto" style="font-size:clamp(1rem,2vw,1.2rem);max-width:580px;line-height:1.7;">
            Dashboard em tempo real, parcelamentos automáticos, contas recorrentes e análises comparativas mês a mês — tudo em um só lugar. Sem planilha. Sem complicação.
        </p>
        ...
        <div class="d-flex justify-content-center gap-4 mt-5 flex-wrap">
            <?php foreach([
                ...
                ['bi-graph-up-arrow','Análises',           'em tempo real'],
            ] as [$icon, $title, $sub]): ?>
        ...
        <div class="row g-4">
            ...
            $features = [
                [
                    ...
                    'desc'  => 'Saldo atual, receitas e despesas do mês com badges de variação comparados ao mês anterior. Saldo projetado incluindo pendentes.',
                ],
                [
                    'icon'  => 'bi-credit-card-2-front',
                    'color' => '#a78bfa',
                    'title' => 'Parcelamento inteligente',
                    'desc'  => 'Comprou um tênis em 5x? O sistema cria uma entrada por mês automaticamente. Aparecem como pendentes no mês certo, sem esforço.',
                ],
                [
                    'icon'  => 'bi-arrow-repeat',
                    'color' => '#22c55e',
                    'title' => 'Contas recorrentes',
                    'desc'  => 'Netflix, aluguel, academia — cadastre uma vez e o Auralis projeta os próximos meses como pendentes, te avisando antes de cair.',
                ],
                [
                    'icon'  => 'bi-pie-chart-fill',
                    'color' => '#f59e0b',
                    'title' => 'Análises por categoria',
                    'desc'  => 'Gráficos de distribuição com % por fatia. Clique numa categoria e veja o histórico detalhado com comparativo do mês anterior.',
                ],
                [
                    'icon'  => 'bi-hourglass-split',
                    'color' => '#38bdf8',
                    'title' => 'Previsão de gastos',
                    'desc'  => 'Barra de "Aguardando confirmação" mostra tudo que ainda vai cair no mês — parcelas futuras e contas recorrentes pendentes.',
                ],
                [
                    'icon'  => 'bi-wallet2',
                    'color' => '#fb7185',
                    'title' => 'Múltiplas carteiras',
                    'desc'  => 'Separe Conta Itaú, Carteira Física e Nubank. Cada carteira tem seu saldo calculado em tempo real — nunca um campo estático.',
                ],
            ];
            foreach ($features as $i => $f):
                $delay = ($i % 3) * 0.15;
            ?>
            <div class="col-12 col-sm-6 col-lg-4 card-animado surgir-baixo" style="transition-delay:<?php echo $delay ?>s;">
                <div class="feature-card h-100">
                    <div class="mb-3 d-flex align-items-center gap-3">
                        ...
                        <h5 class="fw-semibold text-light mb-0"><?php echo $f['title'] ?></h5>
                    </div>
                    <p class="text-secondary mb-0" style="font-size:0.875rem;line-height:1.65;"><?php echo $f['desc'] ?></p>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            $steps = [
                ...
                ['04', '#f59e0b', 'bi-graph-up-arrow',    'Acompanhe as análises',      'Veja para onde vai cada centavo e compare mês a mês.'],
            ];
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 col-md-4 card-animado surgir-baixo">
                <div class="feature-card h-100 text-center">
                    ...
                    <ul class="list-unstyled text-start mb-4" style="font-size:0.85rem;">
                        <?php foreach(['1 carteira','Até 35 registros/mês','Categorias (até 10)','Parcelamento em até 3x','Dashboard básico'] as $item): ?>
            ...
            <div class="col-12 col-md-4 card-animado surgir-baixo" style="transition-delay:.15s;">
                <div class="h-100 rounded-4 overflow-hidden" style="border:1.5px solid #7c3aed88;background:var(--bg-card);">
                    ...
                    <div class="p-4 text-center d-flex flex-column h-100" style="height:calc(100% - 30px) !important;">
                        <p class="fw-semibold small text-uppercase mb-1" style="color:#a78bfa;letter-spacing:.08em;">PRO</p>
                        ...
                        <ul class="list-unstyled text-start mb-4" style="font-size:0.85rem;">
                            <?php foreach(['Carteiras ilimitadas','Registros ilimitados','Categorias ilimitadas','Parcelamento em até 48x','Histórico comparativo (12 meses)','Exportação PDF/Excel','Suporte prioritário'] as $item): ?>
            ...
            <div class="col-12 col-md-4 card-animado surgir-baixo" style="transition-delay:.3s;">
                <div class="h-100 rounded-4 overflow-hidden" style="border:1.5px solid #d4af3766;background:var(--bg-card);">
                    <div class="text-center py-1" style="background:linear-gradient(90deg,#AA8C2C,#d4af37);font-size:0.7rem;font-weight:700;letter-spacing:.08em;color:#121418;">⭐ VIP</div>
                    <div class="p-4 text-center d-flex flex-column" style="height:calc(100% - 30px);">
                        <p class="fw-semibold small text-uppercase mb-1" style="color:#d4af37;letter-spacing:.08em;">VIP</p>
                        <div class="fw-bold text-light mb-0" style="font-size:2rem;">R$ 29,90</div>
                        <p class="text-secondary mb-4" style="font-size:0.8rem;">/mês · Para famílias e empresas</p>
                        <ul class="list-unstyled text-start mb-4" style="font-size:0.85rem;">
                            <?php foreach(['Tudo do PRO','Compartilhamento familiar (4 membros)','Módulo de cartão de crédito','Histórico ilimitado','Metas financeiras','Suporte VIP dedicado'] as $item): ?>
